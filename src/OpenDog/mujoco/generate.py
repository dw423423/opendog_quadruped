...
if __name__ == '__main__':
    ...
    parser.add_argument('--vel-noise', type=float, default=0.,
                        help='IMU velocity estimation noise')
    parser.add_argument('--pos-noise', type=float, default=0.,
                        help='IMU position estimation noise')
    ...
    em_dict = dict(
        ...
        _vel_noise=f'{args.vel_noise:.3f}',
        _pos_noise=f'{args.pos_noise:.3f}',
    )
