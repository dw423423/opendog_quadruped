<mujoco model='DaMiao/OpenDog'>
    ...
    <asset>
        <mesh name='m0_torso'   file='m0_torso.stl' />
        <!-- front left leg -->
        <mesh name='mfl1_hipr'  file='mfl1_hipr.stl' />
        <mesh name='mfl2_hipp'  file='mfl2_hipp.stl' />
        <mesh name='mfl3_knee'  file='mfl3_knee.stl' />
        <mesh name='mfl4_foot'  file='mfl4_foot.stl' />
        <!-- front right leg -->
        <mesh name='mfr1_hipr'  file='mfr1_hipr.stl' />
        <mesh name='mfr2_hipp'  file='mfr2_hipp.stl' />
        <mesh name='mfr3_knee'  file='mfr3_knee.stl' />
        <mesh name='mfr4_foot'  file='mfr4_foot.stl' />
        <!-- rear left leg -->
        <mesh name='mrl1_hipr'  file='mrl1_hipr.stl' />
        <mesh name='mrl2_hipp'  file='mrl2_hipp.stl' />
        <mesh name='mrl3_knee'  file='mrl3_knee.stl' />
        <mesh name='mrl4_foot'  file='mrl4_foot.stl' />
        <!-- rear right leg -->
        <mesh name='mrr1_hipr'  file='mrr1_hipr.stl' />
        <mesh name='mrr2_hipp'  file='mrr2_hipp.stl' />
        <mesh name='mrr3_knee'  file='mrr3_knee.stl' />
        <mesh name='mrr4_foot'  file='mrr4_foot.stl' />
    </asset>
    ...
    <sensor>
        ...
        <velocimeter    name="imu_vel"  site="imu" noise="@_vel_noise"/>
        <framequat      name="imu_quat" objtype="site" objname="imu" noise="@_orie_noise" />
        <framepos       name="imu_pos"  objtype="site" objname="imu" noise="@_pos_noise" />
    </sensor>
</mujoco>
