...
def generate_launch_description():
    ...
    return LaunchDescription([
        # Leaves an 0.8 m buffer before the end of the 8 m terrain.
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={
                'terrain_name': 'rough_terrain_8m_8cm.png',
                # 15 gray levels represent exactly 0.01 m: 15 / 255 * 0.17.
                'terrain_scale': '0.17',
                'terrain_center_x': '4.0',
                'forward_distance': LaunchConfiguration('forward_distance'),
                'perception_parameter_file':
                    package_share + '/config/rough_terrain_parameters.yaml',
