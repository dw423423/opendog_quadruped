...
namespace switched_model {
    ...
    public:
        ...
        SwitchedModelPreComputation(const SwingTrajectoryPlanner &swingTrajectoryPlanner,
        ...
        const SignedDistanceField *getSignedDistanceField() const {
            return swingTrajectoryPlannerPtr_->getSignedDistanceField();
        }
        ...
        const std::vector<kinematic_model_t::CollisionSphere> &collisionSpheresInOriginFrame() const {
        ...
        const matrix_t &footPositionInOriginFrameStateDerivative(size_t leg) const {
            return feetPositionInOriginFrameStateDerivative_[leg];
        }
    ...
    private:
        ...
        static void intermediateLinearOutputs(const ad_com_model_t &adComModel,
        ...
        static void prejumpLinearOutputs(const ad_com_model_t &adComModel,
                                         const ad_kinematic_model_t &adKinematicsModel,
    ...
    public:
        ...
        matrix_t &feetPositionInOriginFrameStateDerivative(size_t leg) {
            return feetPositionInOriginFrameStateDerivative_[leg];
        }
        ...
        std::vector<kinematic_model_t::CollisionSphere> &collisionSpheresInOriginFrame() {
            return collisionSpheresInOriginFrame_;
        }
