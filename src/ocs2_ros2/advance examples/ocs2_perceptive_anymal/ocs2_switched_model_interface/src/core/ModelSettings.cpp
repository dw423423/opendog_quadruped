...
namespace switched_model {
    ...
    ModelSettings loadModelSettings(const std::string &filename, bool verbose) {
        ...
        ocs2::loadData::loadPtreeValue(pt, modelSettings.phaseTransitionStanceTime_,
                                       prefix + "phaseTransitionStanceTime", verbose);
        ...
        ocs2::loadData::loadPtreeValue(pt, modelSettings.autodiffLibraryFolder_, prefix + "autodiffLibraryFolder",
                                       verbose);
        ocs2::loadData::loadPtreeValue(pt, modelSettings.analyticalInverseKinematics_,
                                       prefix + "analyticalInverseKinematics", verbose);
